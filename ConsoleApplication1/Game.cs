...
namespace blackjack
{
    class Game
    {
        ...
        {
            while (hand_zj.checkCount())
            { fapai(checkPicture_zj(), hand_zj,out message); }
            if (hand_zj.count > 21)
            {
                showCard();
                result = true;
                message = "Banker burst the card ,player win!";
                score = getScore(k);
            }
            else
            {
                ...
                else if (hand_zj.count > hand_wj.count)
                {
                    ...
                    result = true;
                    if (hand_zj.count == 21)
                    { message = "banker 21points! you lose!"; }
       ...
       private void showCard()
        ...
        public int getScore(string a)
        {
            ...
            else if (a == "10") num = 100;
            else if (a == "11") num = 110;
            else if (a == "12") num = 120;
            else if (a == "13") num = 130;
            else if (a == "14") num = 140;
            else if (a == "15") num = 150;
            else if (a == "16") num = 160;
            else if (a == "17") num = 170;
            else if (a == "18") num = 180;
            else if (a == "19") num = 190;
            else num = 200;
            return num;
        }
